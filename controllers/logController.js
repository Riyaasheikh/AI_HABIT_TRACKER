...
// @desc    Mark a habit as completed for a given date
// @route   POST /api/logs
...
// @desc    Unmark a habit completion record for a given date
...
// @desc    Get all logs for the current user completed today
...
// @desc    Get all logs within a custom date range
...
// @desc    Get aggregated 90-day activity counts for a heatmap visualization
...
// @desc    Get analytical completion statistics and history for a specific habit
...
export const getHabitStats = async (req, res) => {
  try {
    ...
    const monthly = {};
    for (const l of logs) {
      const m = l.completedDate.slice(0, 7); // Extracts 'YYYY-MM'
...
// @desc    Get dashboard statistics for all unarchived habits over the last 30 days
// @route   GET /api/logs/all-stats
